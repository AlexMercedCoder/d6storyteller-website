---
title: "Dungeon Flippers"
subtitle: "Property Development in the Underdark: When 'Fixer-Upper' Means the Previous Owner Was a Dragon"
genre: "Comedic Fantasy"
tags: ["Humor", "Fantasy", "Real Estate", "Comedy", "Dungeon", "Property", "Satire"]
premise: "The dungeon real estate market is booming. Every dungeon cleared by adventurers represents a potential development opportunity, and the players are dungeon property developers navigating the complex market of acquiring, renovating, and selling (or renting) former monster lairs, ancient tombs, and abandoned wizard towers. The challenge: previous occupants may have booby-trapped the place, cursed it, filled it with architectural decisions that only made sense to a lich, or the dungeon is still occupied and the eviction process for a beholder is legally complicated and practically terrifying."
mechanic: "Property Value Score: Every dungeon property has a Value Score representing its development potential. Characters can increase the Value Score through successful renovations, clearing obstacles, and resolving supernatural encumbrances (curses, haunts, persistent summoning circles). Unsuccessful attempts decrease Value and may trigger complications: a disturbed lich, an activated trap that damages the infrastructure, or a city inspection that reveals the foundation is a sealed portal to another plane -- which absolutely affects the appraisal."
accentColor: "#78350f"
